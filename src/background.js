...
autoUpdater.autoDownload = false // turn off
autoUpdater.autoInstallOnAppQuit = false // turn off
...
async function createWindow () {
  ...
  win = new BrowserWindow({
    ...
    icon: path.join(__static, '/build/icons/icon.ico'), // app Icon
    frame: false,
    webPreferences: {
...
app.on('ready', async () => {
  ...
  await createWindow()
  await autoUpdater.checkForUpdates() // check update
})
